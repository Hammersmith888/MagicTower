...
public class TessellationVertexEffect : BaseMeshEffect
{
	...
	{
		////var verts = help.GetUIVertexStreamList < UIVertex >
		//if (verts.Count == 0)
		//{
		//	// Nothing to do...
		//	return;
	...
	public override void ModifyMesh(Mesh mesh)
	{
		...
		//List<UIVertex> list = new List<UIVertex> (8 * 3 * mesh.vertices.Length);
		//var verts = vertexHelper.GetUIVertexStream(mesh);
		//if (verts.Count == 0)
		//{
		//	// Nothing to do...
		//	return;
		...
		//// Tessellate
		//int startingVertexCount = mesh.vertices.Length;
		//for (int i = 0; i < startingVertexCount; i += 4)
		//{
		//	TessellateQuad(mesh.vertices, i);
		//}

		//// Remove old quads from the start of the list
		//mesh.vertices. .RemoveRange(0, startingVertexCount);
	}
