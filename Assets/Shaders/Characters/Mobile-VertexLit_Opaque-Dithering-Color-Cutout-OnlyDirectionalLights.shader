...
Shader "Custom/VertexLit/Opaque Color CutOff Dithering (Only Directional Lights)"
{
	Properties
    {
	...
	CGPROGRAM
          ...
          //  #pragma multi_compile LIGHTMAP_OFF LIGHTMAP_ON
		    ...
		    fixed4 frag_surf(v2f_surf IN) : SV_Target
		    {
                ...
                ditherClip(IN.screenPos.xy / IN.screenPos.w, _Color.a * _AlphaMultiplier);//Dithering
