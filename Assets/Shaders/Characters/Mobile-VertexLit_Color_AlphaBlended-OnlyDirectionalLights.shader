...
Shader "Custom/VertexLit/Color_AlphaBlended( Only Directional Lights, No shadows, NoLightMaps)" 
{
	Properties
	{
		_MainTex("Base (RGB) Trans (A)", 2D) = "white" {}
		[PerRendererData]_Color("Color Multiplier", Color) = (1,1,1,1)
		[PerRendererData]_AlphaMultiplier("Alpha Multiplier", Range(0,1)) = 1
	}
		...
		SubShader
		{
			...
			Pass
			{
				...
				void surf(Input IN, inout SurfaceOutput o)
				{
					...
					o.Alpha = mainTex.a * _AlphaMultiplier;
				}
